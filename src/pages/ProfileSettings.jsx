        ...
        <div className="relative flex items-start justify-between gap-3">
          <div>
            ...
            <p className="text-zinc-300 text-sm mt-1 max-w-2xl">
              ناو، وێنە، پۆل و لەق — هەمووی لێرە ڕێک بخە. ئەگەر پێویستە پشتڕاستکردنەوەی ئیمەیل بکەیت، لە خوارەوە دەتوانیت.
            </p>
          </div>
        ...
        <div className="rounded-2xl ring-1 ring-white/10 bg-zinc-900/80 backdrop-blur p-5 flex flex-col justify-between">
          <div>
            ...
            <p className="text-sm text-zinc-400 mt-1">
              تکایە ناو، وێنە، پۆل و لەق نوێ بکە و پاشەکەوت بکە. ئەگەر کێشەت هەبوو، دەتوانیت دای‌بنێیتەوە.
            </p>
          </div>
          <motion.button
            whileTap={{ scale: 0.98 }}
